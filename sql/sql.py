...
conn.execute('DELETE from answers where id = 3')
...
# conn.execute('drop table questionnaire')
...
#     cur.execute("INSERT INTO questionnaire (id,title,questions) VALUES (?,?,?)",(1,'Ti全明星阵容', '["1号位","2号位","3号位"]') )     #添加数据，执行单条的sql语句
#     con.commit()  
